...
public class AdvPipeRenderer extends TileEntitySpecialRenderer {
	...
	@Override
	public void bindTexture(final ResourceLocation res) {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		...
		if (pipe.getPipeType() == PipeType.ITEM) {
			renderSolids(pipe.pipe, x, y, z);
		} else if (pipe.getPipeType() == PipeType.FLUID) {
			renderFluids(pipe.pipe, x, y, z);
		} else if (pipe.getPipeType() == PipeType.POWER) {
			renderPower(pipe.pipe, x, y, z);
		} else if (pipe.getPipeType() == PipeType.STRUCTURE) {
			// no object to render in a structure pipe;
		} else {
