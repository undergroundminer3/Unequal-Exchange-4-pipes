 ...
 * and implement IAirReceptor on the TileEntity.
 * <p/>
 ...
 * @see IPowerEmitter
 */
public final class AirHandler implements EnergyAPI.IBatteryProvider {
	...
	public static class PerditionCalculator {
		 ...
		 */
		public double applyPerdition(AirHandler powerHandler, double current, long ticksPassed) {
	...
	public final IAirReceptor receptor;
	...
	private final AirReceiver receiver;
	...
	public AirHandler(IAirReceptor receptor, Type type) {
		this(receptor, type, null);
	}

	public AirHandler(IAirReceptor receptor, Type type, Object battery) {
		this.receptor = receptor;
		this.type = type;
		this.receiver = new AirReceiver();
	...
	public AirReceiver getPowerReceiver() {
		return receiver;
	}
	...
	public final class AirReceiver {

		private AirReceiver() {
		}

		public double getMinEnergyReceived() {
			return AirHandler.this.getMinEnergyReceived();
		}

		public double getMaxEnergyReceived() {
			return AirHandler.this.getMaxEnergyReceived();
		}

		public double getMaxEnergyStored() {
			return AirHandler.this.getMaxEnergyStored();
		}
		...
		public double getEnergyStored() {
			return AirHandler.this.getEnergyStored();
		}
