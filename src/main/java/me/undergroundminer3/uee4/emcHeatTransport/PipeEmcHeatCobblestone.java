...
public class PipeEmcHeatCobblestone extends Pipe<PipeTransportEmcHeat> {

	public PipeEmcHeatCobblestone(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeEmcHeatCobblestone.ordinal();
	}
}
