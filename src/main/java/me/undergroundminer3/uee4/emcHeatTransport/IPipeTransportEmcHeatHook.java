...
public interface IPipeTransportEmcHeatHook {
	 ...
	 */
	public float receiveEmcHeat(final ForgeDirection from, final float val);

	/**
	 * Override default requested power.
	 */
	public float requestEmcHeat(final ForgeDirection from, final float amount);
}
