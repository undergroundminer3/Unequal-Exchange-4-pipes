...
public class PipeEmcHeatStone extends Pipe<PipeTransportEmcHeat> {

	public PipeEmcHeatStone(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeEmcHeatStone.ordinal();
	}
}
