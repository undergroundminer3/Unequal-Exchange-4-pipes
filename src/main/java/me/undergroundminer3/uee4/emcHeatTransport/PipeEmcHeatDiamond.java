...
public class PipeEmcHeatDiamond extends Pipe<PipeTransportEmcHeat> {

	public PipeEmcHeatDiamond(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeEmcHeatDiamond.ordinal();
	}
}
