...
public class PipeEmcHeatQuartz extends Pipe<PipeTransportEmcHeat> {

	public PipeEmcHeatQuartz(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeEmcHeatQuartz.ordinal();
	}
}
