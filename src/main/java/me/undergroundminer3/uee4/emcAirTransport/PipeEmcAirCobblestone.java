...
public class PipeEmcAirCobblestone extends Pipe<PipeTransportEmcAir> {

	public PipeEmcAirCobblestone(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeAirCobblestone.ordinal();
	}
}
