...
public class PipeEmc1Cobblestone extends Pipe<PipeTransportEmc1> {

	public PipeEmc1Cobblestone(Item item) {
	...
	public int getIconIndex(ForgeDirection direction) {
		return EmcPipeIconProvider.TYPE.PipeEmc1Cobblestone.ordinal();
	}
}
