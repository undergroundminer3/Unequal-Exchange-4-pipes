...
public interface IPipeTransportEmc1Hook {
	 ...
	 */
	public float receiveEmc1(final ForgeDirection from, final float val);

	/**
	 * Override default requested power.
	 */
	public float requestEmc1(final ForgeDirection from, final float amount);
}
